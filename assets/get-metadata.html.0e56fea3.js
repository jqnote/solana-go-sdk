import{_ as n,e as s}from"./app.df2b1555.js";const a={},t=s(`<h1 id="get-token-metadata" tabindex="-1"><a class="header-anchor" href="#get-token-metadata" aria-hidden="true">#</a> Get Token Metadata</h1><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	metadataAccount<span class="token punctuation">,</span> err <span class="token operator">:=</span> tokenmeta<span class="token punctuation">.</span><span class="token function">GetTokenMetaPubkey</span><span class="token punctuation">(</span>mint<span class="token punctuation">)</span>
	...
	metadata<span class="token punctuation">,</span> err <span class="token operator">:=</span> tokenmeta<span class="token punctuation">.</span><span class="token function">MetadataDeserialize</span><span class="token punctuation">(</span>accountInfo<span class="token punctuation">.</span>Data<span class="token punctuation">)</span>
	<span class="token keyword">if</span> err <span class="token operator">!=</span> <span class="token boolean">nil</span> <span class="token punctuation">{</span>
