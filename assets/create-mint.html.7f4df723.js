import{_ as n,e as s}from"./app.df2b1555.js";const a={},t=s(`<h1 id="create-mint" tabindex="-1"><a class="header-anchor" href="#create-mint" aria-hidden="true">#</a> Create Mint</h1><p>create a new token</p><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	rentExemptionBalance<span class="token punctuation">,</span> err <span class="token operator">:=</span> c<span class="token punctuation">.</span><span class="token function">GetMinimumBalanceForRentExemption</span><span class="token punctuation">(</span>
		...
		tokenprog<span class="token punctuation">.</span>MintAccountSize<span class="token punctuation">,</span>
	<span class="token punctuation">)</span>
