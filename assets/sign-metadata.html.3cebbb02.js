import{_ as n,e as s}from"./app.df2b1555.js";const a={},t=s(`<h1 id="sign-metadata" tabindex="-1"><a class="header-anchor" href="#sign-metadata" aria-hidden="true">#</a> Sign Metadata</h1><p>to convert a unverified creator to a verifeid creator.</p><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	tokenMetadataPubkey<span class="token punctuation">,</span> err <span class="token operator">:=</span> tokenmeta<span class="token punctuation">.</span><span class="token function">GetTokenMetaPubkey</span><span class="token punctuation">(</span>nft<span class="token punctuation">)</span>
	...
	tx<span class="token punctuation">,</span> err <span class="token operator">:=</span> types<span class="token punctuation">.</span><span class="token function">NewTransaction</span><span class="token punctuation">(</span>types<span class="token punctuation">.</span>NewTransactionParam<span class="token punctuation">{</span>
		...
		Message<span class="token punctuation">:</span> types<span class="token punctuation">.</span><span class="token function">NewMessage</span><span class="token punctuation">(</span>types<span class="token punctuation">.</span>NewMessageParam<span class="token punctuation">{</span>
			...
			Instructions<span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token punctuation">]</span>types<span class="token punctuation">.</span>Instruction<span class="token punctuation">{</span>
				tokenmeta<span class="token punctuation">.</span><span class="token function">SignMetadata</span><span class="token punctuation">(</span>tokenmeta<span class="token punctuation">.</span>SignMetadataParam<span class="token punctuation">{</span>
